...
from Others.Ordinal_50_Class_Method import training
from Others.Ordinal_50_Class_Method.evaluation import (  # noqa: E402
    plot_grouped_recall_matrix,
    print_ordinal_50_class_summary,
    summarize_ordinal_50_class_results,
)
...
trainer = training.Ordinal50ClassTrainer(
    training.Ordinal50ClassConfig(
        epochs=1000,
        batch_size=128,
        lr=3e-4,
        weight_decay=1e-3,
...
result_summary = summarize_ordinal_50_class_results(fold_results)
print_ordinal_50_class_summary(result_summary)
