...
from Others.Two_Stage_Residual_Ordinal_Method import training
from Others.Two_Stage_Residual_Ordinal_Method.evaluation import (  # noqa: E402
    plot_grouped_recall_matrix,
    print_two_stage_residual_ordinal_summary,
    summarize_two_stage_residual_ordinal_results,
)
...
trainer = training.TwoStageResidualOrdinalTrainer(
    training.TwoStageResidualOrdinalConfig(
        epochs=1000,
        liquid_batch_size=128,
        concentration_batch_size=32,
        liquid_lr=1e-3,
        concentration_lr=3e-4,
        liquid_weight_decay=1e-1,
        concentration_weight_decay=1e-1,
        verbose=True,
        residual_mode="residual_only",
        use_test_early_stopping=True,
        early_stopping_patience=300,
        use_liquid_pretraining=True,
...
result_summary = summarize_two_stage_residual_ordinal_results(fold_results)
print_two_stage_residual_ordinal_summary(result_summary)
