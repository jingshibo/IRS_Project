...
from Others.Regression_Method import training  # noqa: E402
from Others.Regression_Method.evaluation import (  # noqa: E402
...
trainer = training.RegressionTrainer(
    training.RegressionConfig(
        epochs=1000,
        batch_size=128,
        verbose=True,
...
result_summary = summarize_regression_results(fold_results)
print_regression_summary(result_summary)
