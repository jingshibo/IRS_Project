...
from Others.Residual_Ordinal_Method import training  # noqa: E402
from Others.Residual_Ordinal_Method.evaluation import (  # noqa: E402
    plot_grouped_recall_matrix,
    print_residual_ordinal_summary,
    summarize_residual_ordinal_results,
)
...
trainer = training.ResidualOrdinalTrainer(
    training.ResidualOrdinalConfig(
        epochs=1000,
        batch_size=128,
        verbose=True,
        concentration_loss_weight=10.0,
...
result_summary = summarize_residual_ordinal_results(fold_results)
print_residual_ordinal_summary(result_summary)
