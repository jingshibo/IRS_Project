...
from Others.Ordinal_Method import training
from Others.Ordinal_Method.evaluation import (  # noqa: E402
    plot_grouped_recall_matrix,
    print_ordinal_summary,
    summarize_ordinal_results,
)
...
trainer = training.OrdinalTrainer(
    training.OrdinalConfig(
        epochs=1000,
        batch_size=128,
        verbose=True,
        concentration_loss_weight=5.0,
...
result_summary = summarize_ordinal_results(fold_results)
print_ordinal_summary(result_summary)
