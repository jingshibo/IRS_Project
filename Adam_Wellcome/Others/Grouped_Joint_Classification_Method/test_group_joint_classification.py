...
from Others.Grouped_Joint_Classification_Method import training  # noqa: E402
from Others.Grouped_Joint_Classification_Method.evaluation import (  # noqa: E402
    plot_grouped_recall_matrix_with_numbers,
    print_grouped_joint_classification_summary,
    summarize_grouped_joint_classification_results,
)
...
trainer = training.GroupedJointClassificationTrainer(
    training.GroupedJointClassificationConfig(
        epochs=1000,
        batch_size=128,
        lr=1e-3,
        weight_decay=1e-2,
...
result_summary = summarize_grouped_joint_classification_results(fold_results)
print_grouped_joint_classification_summary(result_summary)
