...
from Others.Two_Stage_Ordinal_Method import training  # noqa: E402
from Others.Two_Stage_Ordinal_Method.evaluation import (  # noqa: E402
...
trainer = training.TwoStageOrdinalTrainer(
    training.TwoStageOrdinalConfig(
        epochs=1000,
        ...
        concentration_weight_decay=1e-2,
        verbose=True,
...
result_summary = summarize_two_stage_ordinal_results(fold_results)
print_two_stage_ordinal_summary(result_summary)
