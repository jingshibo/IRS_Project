...
from Grouped_Two_Head_Classification_Method import training
from Grouped_Two_Head_Classification_Method.evaluation import (  # noqa: E402
    plot_grouped_recall_matrix_with_numbers,
    print_grouped_classification_summary,
    summarize_grouped_classification_results,
)
...
trainer = training.GroupedClassificationTrainer(
    training.GroupedClassificationConfig(
        epochs=1000,
        batch_size=128,
        lr=1e-3,
        weight_decay=1e-2,
        verbose=True,
        concentration_loss_weight=1.0,
        concentration_label_smoothing=0.0,
...
result_summary = summarize_grouped_classification_results(fold_results)
print_grouped_classification_summary(result_summary)
